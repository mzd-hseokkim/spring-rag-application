...
import kr.co.mz.ragservice.document.collection.DocumentCollection;
import kr.co.mz.ragservice.document.collection.DocumentCollectionRepository;
import kr.co.mz.ragservice.document.pipeline.IngestionEventPublisher;
import kr.co.mz.ragservice.document.pipeline.IngestionPipeline;
import kr.co.mz.ragservice.document.tag.DocumentTag;
import kr.co.mz.ragservice.document.tag.DocumentTagRepository;
...
public class DocumentController {
    ...
    public ResponseEntity<DocumentResponse> upload(@RequestParam("file") MultipartFile file,
        ...
        try {
            ...
            throw new kr.co.mz.ragservice.common.RagException("Failed to read file", e);
        }
